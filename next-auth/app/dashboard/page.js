        ...
        >
          ...
          >
            ...
            <h3 className="text-lg font-bold mb-4">
              {featureMeta[activeFeature]?.label}
            </h3>

            {/* ✅ Image (ใช้ร่วมได้ / ไม่ซ้ำ) */}
            {featureMeta[activeFeature]?.image && (
              <img
                src={featureMeta[activeFeature].image}
                alt={activeFeature}
            ...
            <p className="text-sm text-gray-600">
              {
                featureMeta[activeFeature]
                  ?.examples?.[results.details[activeFeature]]
                  ?.description
              }
            </p>
          </div>
